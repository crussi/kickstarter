...
export default () => {
  ...
  var links6 = [];
  links6.push({url: '/link-calendar', name: '/link-calendar'} );
  links6.push({url: '/available-calendars', name: '/available-calendars'} );
  let navCalendar = React.createElement(Dropdown, {name: 'Calendar', links: links6});
